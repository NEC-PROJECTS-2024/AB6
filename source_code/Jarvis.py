    ...
    if prob.item() > 0.75:
        for intent in intents['intents']:
            if tag == intent["tag"]:
                ...
                if "time" in reply or "date" in reply or "day" in reply or "joke" in reply or "wishes" in reply:
                    result = NonInputExecution(reply)
                    if result is not None:
                        additional_messages.append(result) 
                elif "wikipedia" in reply  or "greetings" in reply  or "bye" in reply or "health" in reply or "identity" in reply or "personal" in reply or "activity" in reply or "insult" in reply or "exclaim" in reply or "google" in reply or "youtube" in reply or "whatsapp" in reply or "math" in reply or "songs" in reply or "laptop" in reply or "website" in reply or "voice type" in reply or "helping mode" in reply or "weather" in reply or "noanswer" in reply:
